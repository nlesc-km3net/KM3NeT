...
#drv.memset_d32(correlations_gpu, 0, (correlations.shape[0]*correlations.shape[1])/4)
...
print("Done.")
print('np.sum(correlations - correlations_ref) = ', np.sum(correlations - correlations_ref))
