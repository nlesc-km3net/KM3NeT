...
def test_Match3BSparse():
    ...
    try:
        ...
        kernel = Match3BSparse(N, window_width, cc)

        d_col_idx, d_prefix_sums, d_degrees, total_hits = kernel.compute(x, y, z, ct)
    ...
    correlations = util.correlations_cpu_3B(correlations, x, y, z, ct)
